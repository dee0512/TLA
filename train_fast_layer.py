...
def train(seed=0, start_timesteps=25e3, eval_freq=5e3, max_timesteps=1e5, expl_noise=0.1, batch_size=256, discount=0.99,
          tau=0.005, policy_freq=2, policy_noise=2, noise_clip=0.5,
          response_rate=0.04, env_name='InvertedPendulum-v2', parent_response_rate=0.04, penalty=False,
          with_parent_action=False, double_action=False):
    delayed_env = True
    ...
    arguments = [augment_type, env_name, seed, response_rate, parent_response_rate]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--parent_response_rate", default=0.04, type=float,
                        help="Response time of the agent in seconds")
